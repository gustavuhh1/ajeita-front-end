...
export default function RedefinirSenhaPrestadorPage() {
        ...
        <section className="w-full max-w-lg rounded-4xl border border-gray-100 bg-white p-8 shadow-lg">
          ...
          <div className="mb-8 text-center">
            ...
            <h1 className="text-2xl font-semibold text-gray-950">
              Redefinir senha do prestador
            </h1>

            <p className="mt-2 text-sm leading-relaxed text-gray-500">
              {token
                ? "Crie uma nova senha para recuperar o acesso à sua conta profissional."
                : "Não encontramos o token no link. Solicite uma nova recuperação de senha."}
            </p>
          </div>
