                ...
                if (item.href === "#") {
                  return (
                    <button
                      key={item.name}
                      type="button"
                      className="relative flex w-full items-center gap-4 rounded-3xl px-5 py-4 text-sm font-black text-gray-400 transition-all hover:bg-gray-50 hover:text-gray-700"
                    >
