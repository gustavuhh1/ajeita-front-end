...
const ProfileAddressesPage = () => {
  ...
  return (
    /* ADICIONADO: flex e flex-col para permitir o empurrão do footer */
  ...
  <div className="max-w-[1400px] mx-auto px-6 py-3 flex items-center justify-between">
    ...
    <div className="flex items-center gap-6">
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Foto de Perfil do Ricardo aplicada aqui */}
        <div className="w-10 h-10 rounded-full border border-gray-200 bg-orange-100 overflow-hidden cursor-pointer">
          <img 
      ...
      {/* CONTEÚDO (ADICIONADO: flex-grow para ocupar o espaço restante) */}
      <div className="max-w-[1200px] mx-auto flex gap-10 p-10 flex-grow w-full">
        <aside className="w-72 flex-shrink-0">
          <div className="bg-white rounded-[40px] p-8 border border-gray-100 shadow-sm flex flex-col h-fit sticky top-24">
            <div className="flex items-center gap-4 mb-10">
              <div className="w-14 h-14 rounded-2xl bg-orange-100 overflow-hidden border-2 border-white shadow-sm">
        ...
        <main className="flex-grow">
          ...
          <div className="mt-8 bg-gray-50 rounded-[30px] p-6 border border-gray-100 flex gap-4 items-center">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              Você pode cadastrar até 5 endereços. O marcado como <span className="font-bold text-gray-700">Principal</span> será sugerido automaticamente em novos pedidos.
            </p>
          </div>
        </main>
      </div>

      {/* FOOTER (AJUSTADO: mt-auto para garantir que desça) */}
      <footer className="w-full py-8 border-t border-gray-100 bg-white mt-auto">
        <div className="max-w-[1200px] mx-auto px-10 flex justify-between items-center text-[11px] font-bold text-gray-400 uppercase tracking-widest">
      ...
      {/* MODAL ADICIONAR ENDEREÇO (Igual ao seu) */}
      {isModalOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-gray-900/60 backdrop-blur-sm p-4">
          <div className="bg-white w-full max-w-2xl rounded-[40px] overflow-hidden shadow-2xl">
            ...
            <form onSubmit={handleSaveAddress} className="p-10 pt-2 space-y-6">
              ...
              <div>
                <label className="block text-[11px] font-bold text-gray-400 mb-2 uppercase tracking-widest">Logradouro (Rua/Avenida)</label>
              ...
              <div>
                <label className="block text-[11px] font-bold text-gray-400 mb-2 uppercase tracking-widest">Apelido do Endereço</label>
              ...
              <div className="flex gap-4 pt-4">
                <button type="button" onClick={() => setIsModalOpen(false)} className="flex-grow py-5 text-gray-400 font-bold rounded-2xl hover:bg-gray-50 transition-colors border border-transparent">Cancelar</button>
                <button type="submit" className="flex-grow py-5 bg-yellow-400 text-gray-900 font-bold rounded-[22px] hover:bg-yellow-500 shadow-xl shadow-yellow-100 transition-all">Salvar Endereço</button>
              </div>
            </form>
          </div>
        </div>
