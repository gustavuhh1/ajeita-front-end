      ...
      <div className="flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-xl rounded-3xl border border-gray-200 bg-white p-8 text-center">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link href="/pedidos">
              <button className="w-full rounded-full border border-gray-200 py-3 text-sm text-gray-600 hover:bg-gray-50 transition flex items-center justify-center gap-2">
                Voltar para pedidos
                <ArrowRight size={16} />
              </button>
            </Link>
